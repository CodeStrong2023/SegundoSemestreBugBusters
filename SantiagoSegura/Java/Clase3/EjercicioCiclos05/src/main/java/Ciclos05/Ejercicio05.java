...
para ello generar un numero aleaotrio entre 0-100, y
luego ir pidiendo numeros indicando "es mayor" o "es menor
segun sea mayor o menor con respecto a N
El proceso termina cuando el usurario acierta y mostramos
    ...
    public static void main(String[] args) {
        ...
        do{
            ...
            if(numero < aleatorio){
                ...
                JOptionPane.showMessageDialog(null, "¡¡¡FELICIDADES!!! Has adibinado el numero");
            }
            conteo++;
