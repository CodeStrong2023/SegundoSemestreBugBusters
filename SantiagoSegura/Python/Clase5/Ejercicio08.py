...
# Hacer un programa que simule un cajero automatico que simule un cajero automatico con un saldo
# inicil de 1000$ y tendra el siguiente menu de opciones:
...
while True:
    print("\t.:MENÚ.:")
    print("1. Ingresar dinero en la acuenta")
