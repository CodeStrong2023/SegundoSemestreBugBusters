...
persona2 = Persona("Nicolas", "Nuñez", 44248194, 21)
...
persona3 = Persona("Rogelio", "Romero", 44123567, 22, "Telefono", "2604556677", "Calle Lopez", 823, "Manzana", 77, "Casa", 18, Altura = 1.88, Peso = 105, CFavorito = "Azul", Auto = "Citroen", Modelo = 2021)
